function [ I ] = HeatEquationRGB( I, tend, dt, strIn )
...
%     end
    ...
    %colon notation
    I(2:m-1,2:n-1,:) = Iold(2:m-1,2:n-1,:) + ...
        dt*((Iold(3:m,2:n-1,:) - 2*Iold(2:m-1,2:n-1,:) ... 
        + Iold(1:m-2,2:n-1,:)) / dx^2 + (Iold(2:m-1,3:n,:) - 2*Iold(2:m-1,2:n-1,:) + Iold(2:m-1,1:n-2,:))/dy^2);
end
